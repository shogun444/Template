...
<div className="col-span-1">
   <PricingCard>
          ...
          >
            <Button varient="pricing">Start your free trial</Button>
          </CardLeft>
          <CardRight>
        ...
        <PricingCard>
          ...
          >
            <Button varient="pricing">Contact Sales</Button>
          </CardLeft>
          <CardRight>
            <Svg>
              Upto 5 AI Agents   
